        ...
        @foreach($data as $datas)
            <form action="{{ route('relawan.update', $datas->id_relawan) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="" class="form-control" id="usr" name="id_relawan" value="{{ $datas->id_relawan }}" readonly="true">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="usia" name="usia" value="{{ $datas->usia }}">
                </div>
                <tr>
                <div class="form-group">
